...
--num_features 50 --loadpre ./data/uniter-large.pt --num_pos 6 --contrib --midsave $midsave --exp U50 --topk $topk
...
--train train --valid dev_seen --test dev_seen --lr 1e-5 --batchSize 8 --tr bert-large-cased --epochs 5 --tsv \
--num_features 72 --loadpre ./data/uniter-large.pt --num_pos 6 --contrib --midsave $midsave --exp U72 --topk $topk
...
--train train --valid dev_seen --test dev_seen --lr 1e-5 --batchSize 8 --tr bert-large-cased --epochs 5 --tsv \
--num_features 36 --loadpre ./data/uniter-large.pt --num_pos 6 --contrib --midsave $midsave --exp U36 --topk $topk
