...
from reader._tsv_reader import ImageFeaturesH5Reader

from preprocess import preprocessor
from batching.finetune_batching import prepare_batch_data_hm
...
class HMReader(object):
    """ 
    Data reader for sub HM task
    """
    def __init__(self,
                 task_conf,
                 split,
        ...
        self._entries = _load_annotationsHM(annotations_jsonpath, split)
    ...
    def replace_det_with_name(self, inputs, random_names):
        ...
        for w in inputs:
            if isinstance(w, list):
                ...
                if sys.version[0] == '2':
                    word = w.encode('utf-8') # Not necessary in Python 3
                else:
                    word = w
                tokens.append(word)
    ...
    def tokenize(self):
        ...
        for entry in self._entries:
            ...
            # Remove apostrophes & whitespaces
            #text_or = entry["text"]
            #entry["text"] = " ".join(str(entry["text"]).split())
            ...
            #self._truncate_seq_pair(ids_a, ids_b, self.max_seq_len - 3)      ### We'll make sure each example is within seq_len
    ...
    def data_generator(self):
        ...
        Data_generator 
        """
        # Python 3 does not support range item assignment
...
class HMDataReader(object):
    """ 
    Data reader for HM task
    """
    def __init__(self,
                 task_conf_group,
                 split,
        ...
        for task_index, task_conf in enumerate(task_conf_group):
            self.task_readers.append(HMReader(task_conf, split, vocab_path, batch_size, shuffle,
    ...
    def data_generator(self):
        ...
        def wrapper():
            ...
            #itertools.izip for Python 2 instead of zip
            #https://diveintopython3.net/porting-code-to-python-3-with-2to3.html#itertools
