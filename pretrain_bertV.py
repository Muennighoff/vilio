...
from src.vilio.modeling_bertV import BertVPretraining
...
class LXMERT:
    def __init__(self, max_seq_length):
        ...
        self.model.bert.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0, std=self.model.bert.config.initializer_range)
    ...
    def forward(self, examples):
        ...
        loss, losses, ans_logit = self.model(
            ...
            matched_label=matched_labels, obj_labels=obj_labels, num_features=args.num_features
        )
    ...
    def save(self, name):
        torch.save(self.model.state_dict(),
                   os.path.join(args.output, "%s_BV.pth" % name))
